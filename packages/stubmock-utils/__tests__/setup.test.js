  ...
  describe('createHandler', () => {
    ...
    it('should handle jwt', async () => {
              ...
              response: [
                {
                  ...
                  body: {
                    ...
                    expires_in: 86399,
                    id_token:
                      '${{ jwt({"sub":"eaf0f6d3-6e45-46d4-9c0d-3a2383d352b7","aud":"sand_man","displayName":"laser shark","kid":"rsa1","iss":"http://sandbox:8060/","exp":"${{ now(3600,"sec") }}","iat":"${{ now(3600,"sec") }}","email":"va-lasershark-team@stubmock.io"},"secret",{"header":{"kid":"rsa1"}}) }}',
      ...
      expect(mockReplySend).toHaveBeenCalledWith({
        ...
        expires_in: 86399,
        id_token:
          'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6InJzYTEifQ..m54DqHCFOBiQE-8f-kmfMkk2vKicurdv0MIClLKK8IQ',
        scope: 'smart/orchestrate_launch openid user/*.* profile',
        token_type: 'Bearer',
      });
    });
